...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create(['name' => 'Admin Alpha', 'email' => 'admin@alpha.test', 'password' => Hash::make('password'), 'school_id' => $alpha->id]);
        User::create(['name' => 'Admin Bright', 'email' => 'admin@bright.test', 'password' => Hash::make('password'), 'school_id' => $bright->id]);
