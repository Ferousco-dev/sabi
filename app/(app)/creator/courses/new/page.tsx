  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        <Input label="Course Title" value={title} onChange={setTitle} placeholder="e.g. Mathematics for JSS3" />
        <div>
        ...
        <Input label="Price (₦)" type="number" value={price} onChange={setPrice} placeholder="0.00" />
