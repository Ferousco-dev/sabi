...
export default function MessagesPage() {
  ...
  const load = () => getTeacherMessages().then((res) => {
  ...
  return (
    <>
      <PageHeader title="Messages" subtitle="Reach students, parents, and staff." />
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 20, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: "1.2 1 340px", minWidth: 0 }}>
          <Card title="Conversations" padded={false}>
            {threads.length === 0 ? (
              <EmptyState Icon={MessageSquare} title="No conversations yet" description="Start a new message to communicate with students or staff." />
            ) : (
