<?php
// api/schools/import-students.php
// Bulk-create students from pasted CSV rows: name,email[,phone]
// class_id is accepted but class placement is done separately via enrollments
// (which require an academic session), so it is ignored here for now.
...
$insert = $db->prepare("INSERT INTO users (name, email, password_hash, role, phone) VALUES (?, ?, ?, 'student', ?)");
